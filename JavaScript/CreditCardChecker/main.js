...
console.log(invalid); // All invalid card arrays

const companies = idInvalidCardCompanies(invalid);
console.log(companies); // List of companies issuing invalid cards
